...
public class DinamicaMejoradaTest {
	@Test
	public void dinamicaMejoradaTestComplete() throws Exception{
		...
		PrintWriter salida = new PrintWriter(new FileWriter(miPath+"DinamicaM.out"));
		
		// METODO 5 - DINAMICA MEJORADA
		
	
		
		System.out.println("Programacion Dinamica Mejorada:");
		salida.println("Programacion Dinamica Mejorada:");	
		// Polinomio 5
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p5.evaluarMejorada(1);
