...
public class HornerTest 
{
	...
	{
		double resH, resD, resR;
		Polinomio p10 = new Polinomio("tests/Entrada/Polinomio_10.in");
		
		resH = p10.evaluarHorner(2.1);
		resD = p10.evaluarProgDinamica(2.1);
		resR = p10.evaluarRecursiva(2.1);
		
		//System.out.println(resH + " " + resD + " " + resR);
		Assert.assertEquals(resH, resD, 0.001);
		Assert.assertEquals(resH, resR, 0.001);
	}
	@Test
	public void hornerTestComplete() throws Exception
	{
		...
		PrintWriter salida = new PrintWriter(new FileWriter(miPath+"Horner.out"));
		...
		salida.println("Horner:");	
		// Polinomio 5
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p5.evaluarProgDinamica(1);
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p100.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p500.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p1000.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p2000.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p3000.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p4000.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p5000.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p6000.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p7000.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p8000.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p9000.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
		...
		// Inicio la toma de datos
		tIni = new GregorianCalendar();		
		res = p10000.evaluarProgDinamica(1);
		tFin = new GregorianCalendar();
		System.out.println("Resultado: "+res);
		salida.println("Resultado: "+res);			
		diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();			
