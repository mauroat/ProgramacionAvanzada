...
public class PowTest {
	...
	public void dinamicaMejoradaTestComplete() throws Exception{
		...
		PrintWriter salida = new PrintWriter(new FileWriter(miPath+"Pow.out"));
