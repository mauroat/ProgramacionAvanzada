...
public class InicioSesion extends JFrame {
	 ...
	 * Create the frame.
	 */
	public InicioSesion(final Usuario usuario,final Semaphore sem) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				usuario.setNombre_usuario(textField.getText());
				usuario.setPassword_usuario(passwordField.getText());
				usuario.setOpcion(1);
				sem.release();
