...
public class CrearPersonajeviejo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CrearPersonajeviejo frame = new CrearPersonajeviejo(new Humano(),new Semaphore(0));
	 ...
	 * Create the frame.
	 */
	public CrearPersonajeviejo(final Personaje p1,final Semaphore sem) {
